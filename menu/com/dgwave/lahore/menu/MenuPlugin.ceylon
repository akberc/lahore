...
import com.dgwave.lahore.help { HelpHook }

id("menu")
name("Menu")
description("Allows administrators to customize the site navigation menu.")
configure("admin/structure/menu")
shared class MenuPlugin() satisfies Plugin & HelpHook {
	...
	route("menu_settings", "GET", "/admin/structure/menu/settings", "administer menu")
	shared Result menuSettings(Context c) => ctl1.menuSettings(c);
	
	route("menu_link_reset", "GET", "admin/structure/menu/item/{menu_link}/reset", "administer menu")
	shared Result menuLinkReset(Context c) => ctl1.menuLinkReset(c);

	route("menu_link_delete", "GET", "admin/structure/menu/item/{menu_link}/delete", "_access_menu_delete_link: 'TRUE'")
	shared Result menuLink_delete(Context c) => entForm1.menuLink_delete(c);

	route("menu_delete_menu", "GET", "admin/structure/menu/manage/{menu}/delete", "_access_menu_delete_link: 'TRUE'")
